    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white shadow-sm rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Edit Kategori: {{ $category->name }}</h2>
                <p class="mt-1 text-sm text-gray-600">Perbarui informasi kategori songket.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-amber-500 focus:ring-amber-500">{{ old('description', $category->description) }}</textarea>
                    ...
                    <x-image-upload name="image" label="Gambar Kategori" :multiple="false" :max-files="1"
                        :max-size="2048" :existing-images="$existingImages"
